  ...
  return (
    ...
    >
      <div className="relative">
        ...
        <input
          className={`cursor-pointer text-black w-full pl-10 pr-10 py-3.5 border ${
        ...
        {type === "password" && (
          <button
            type="button"
            className="cursor-pointer absolute inset-y-0 right-0 pr-3 flex items-center text-gray-500 hover:text-indigo-700 transition-colors"
